...
Superpowers is officially supported in [Claude Code](#claude-code), [Codex CLI](#codex-cli), [Codex App](#codex-app), [Factory Droid](#factory-droid), [Gemini CLI](#gemini-cli), [OpenCode](#opencode), [Cursor](#cursor), [GitHub Copilot CLI](#github-copilot-cli), and [Antigravity](#antigravity).
...
**Custom Skills**
- **deploying-payload-to-cloudflare** - Deploy Payload CMS to Cloudflare Workers
- **implementing-schema-org** - Implement Schema.org structured data
